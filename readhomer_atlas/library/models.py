...
class TextAlignment(models.Model):
    ...
    versions = SortedManyToManyField("library.Node", related_name="text_alignments")
    """
    versions being sorted maps onto the "items" within a particular chunk
    """
...
class TextAlignmentChunkRelation(models.Model):
    ...
    alignment_chunk = models.ForeignKey(
        "library.TextAlignmentChunk", on_delete=models.CASCADE, related_name="relations"
    )
