...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://localhost/lemma-content-atlas"
    )
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "lemma_content_atlas.context_processors.settings",
            ],
        },
    }
]
...
ROOT_URLCONF = "lemma_content_atlas.urls"

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = "lemma_content_atlas.wsgi.application"
...
GRAPHENE = {
    "SCHEMA": "lemma_content_atlas.schema.schema",
